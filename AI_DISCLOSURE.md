...
The consecutive-peak continuous wavelet transform method that underlies this software, and the scientific findings reported in the accompanying manuscript, were conceived and developed by Wolf Henning Gebhardt. The earliest written record of the method is the 2017 IMB / EMBL Mainz draft manuscript (*Wavelet analysis of consecutive DNase hypersensitivity peaks reveals an approximate periodic fold of chromatin accessibility on MCF-7 chromosome X*, unpublished, on file with the author), which predates the broad availability of large-language-model AI tools. The 2026 manuscript and patent filing develop this initial observation into a quantitative, cross-species, mechanism-linked phenomenon.
