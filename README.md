...
> Gebhardt, W. H. (2026). **A periodic supra-compartment fold maps chromosomes to nuclear environments and constrains genomic rearrangement.** Manuscript submitted for publication.
...
The methods implemented are the subject of a Swiss patent application filed 3 May 2026 (Wolf Henning Gebhardt, sole inventor); see [PATENT_NOTICE.md](PATENT_NOTICE.md) for the complete patent disclosure. Commercial licensing inquiries: **w.gebhardt@protonmail.com**.
